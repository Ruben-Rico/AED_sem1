...
# Crear el mapa de calor de las correlaciones con valores numéricos
corrplot(correlaciones, method = "color", col = colorRampPalette(c("lightblue", "lightyellow", "red"))(50),
         number.cex = 0.5, tl.cex = 0.8, tl.col = "black")
...
"datos" previo al análisis de la información:
